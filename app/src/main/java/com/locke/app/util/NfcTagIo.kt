...
/**
 * Reads/writes a plain NDEF text record for [com.locke.app.domain.model.HabitType.TAG_SCAN]
 * habits -- the tag just carries this habit's random [com.locke.app.domain.model.Habit.tagPayload]
