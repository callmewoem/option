 ...
 * in [com.locke.app.data.local.entity.HabitCompletionEntity].
 */
object DateProvider {
    ...
    /** "yyyy-MM", the calendar month this device's clock is currently in -- see [com.locke.app.data.repository.PreferencesRepository]'s free-tier monthly quota (photo verification). */
    fun currentMonthString(): String = LocalDate.now().format(MONTH_FORMATTER)
