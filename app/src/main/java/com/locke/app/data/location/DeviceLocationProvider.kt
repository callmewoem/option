package com.locke.app.data.location
...
/**
 * Thin wrapper around [LocationManager] for [com.locke.app.domain.model.HabitType.VISIT_LOCATION]
 * habits (see [com.locke.app.service.LocationSyncWorker]).
 *
 ...
 * mirrors [com.locke.app.data.healthconnect.HealthConnectManager]'s own
