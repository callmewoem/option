...
import com.locke.app.data.remote.AccountabilityApiException
 ...
 * ([setShareStatsEnabled]) is never gated -- see that function's doc. Mirrors the "seam
 * behind a stub-swappable interface" shape of
 * [com.locke.app.data.billing.EntitlementRepository].
 */
@Singleton
class AccountabilityRepository @Inject constructor(
     ...
     * themselves, e.g. [com.locke.app.ui.settings.SettingsViewModel] on
