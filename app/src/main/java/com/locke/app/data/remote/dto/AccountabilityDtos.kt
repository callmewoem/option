...
/** Throws [org.json.JSONException] on a malformed body -- callers wrap this in a try/catch and surface [com.locke.app.data.remote.AccountabilityApiException.Api]. */
