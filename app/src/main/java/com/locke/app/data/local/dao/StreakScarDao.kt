...
interface StreakScarDao {
    ...
    /** Full scar rows (date + why) in range -- [getScarredDatesInRange] only has the dates, which is all the heatmap/streak calc need, but [com.locke.app.util.StatsExportUtil]'s export wants the reason too. */
