...
import com.locke.app.util.PremadeBlocklists
...
/** One matched domain's rule, keyed by host for [AppBlockAccessibilityService][com.locke.app.service.AppBlockAccessibilityService]'s per-navigation lookup. */
