...
class PreferencesRepository @Inject constructor(
    ...
    /** See [com.locke.app.data.repository.LockoutRepository]. 0 = no active lockout. */
     ...
     * resume) -- how [com.locke.app.AppViewModel] tells "the user just
    ...
    /** See [com.locke.app.data.repository.LimitedUnblockRepository]. */
    ...
    /** Persisted result of the (future) purchase flow. See [com.locke.app.data.billing.EntitlementRepository]. */
    ...
    /**
     * What [com.locke.app.service.AppUsageSyncer]'s last run (periodic
     ...
     * [com.locke.app.data.remote.BackendConfig]) -- minted once by
     * [com.locke.app.data.remote.DeviceIdentityRepository] on first
    ...
    /** This device's own pairing code, last minted by [com.locke.app.data.repository.AccountabilityRepository.regeneratePairingCode]. Null until generated once. */
    ...
    /** Guards [com.locke.app.service.WeeklyDigestWorker] against posting the same week's recap twice. */
