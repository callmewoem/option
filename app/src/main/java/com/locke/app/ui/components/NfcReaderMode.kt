...
/** Whether this device has NFC hardware at all -- [com.locke.app.domain.model.HabitType.TAG_SCAN]'s NFC path hides itself when false (QR still works everywhere). */
@Composable
 ...
 * [com.locke.app.domain.model.HabitType.TAG_SCAN]'s "write to my tag"
