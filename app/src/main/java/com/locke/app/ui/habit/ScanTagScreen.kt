...
import com.locke.app.ui.components.NfcReaderModeEffect
import com.locke.app.ui.components.rememberNfcAvailable
import com.locke.app.util.ImageStore

/**
 * "Tap your tag, or scan its QR code" -- the completion flow for a
 * [com.locke.app.domain.model.HabitType.TAG_SCAN] habit. NFC reader mode
 * runs the whole time this screen is open (see [NfcReaderModeEffect]); QR is a one-shot
 * camera capture, same shape as [com.locke.app.ui.components.PhotoVerificationCapture]
