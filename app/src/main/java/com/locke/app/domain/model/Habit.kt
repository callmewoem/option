...
data class Habit(
     ...
     * TRACKED and are promoted one at a time by [com.locke.app.data.repository.EaseInRepository].
     */
    ...
    companion object {
        /** Default/fallback radius for a [HabitType.VISIT_LOCATION] habit's target, in meters -- shared by the add/edit form's radius picker and [com.locke.app.service.LocationSyncWorker]'s fallback for an old row saved before a radius was chosen. */
