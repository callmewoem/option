package com.habitsfirst.androidclone.ui.paywall
...
fun PaywallContent(state: PaywallUiState, onPurchase: (productId: String) -> Unit) {
    ...
    listOf(
        "Unlimited gating habits -- no cap on how many apps you can lock your life behind.",
        "AI photo checking for photo-verified habits and the morning check-in.",
        "Accountability buddies -- pair up and share daily progress.",
    ).forEach { line ->
