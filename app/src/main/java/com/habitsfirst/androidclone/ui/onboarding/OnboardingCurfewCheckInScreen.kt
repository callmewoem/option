 ...
 * by the same AI verification as photo-verification habits -- a premium feature (see
 * `OnboardingPaywallScreen`, the step right after this one) -- disclosed here rather
 * than sprung on the person the first time they try to use it (design spec §9,
 * onboarding screen 7).
 */
@Composable
                        ...
                        Column(modifier = Modifier.weight(1f)) {
                            ...
                            Text(
                                "A photo proving you're up, checked by the same AI as photo-verification " +
                                    "habits (Premium -- see the next step). Miss the window and the block extends " +
