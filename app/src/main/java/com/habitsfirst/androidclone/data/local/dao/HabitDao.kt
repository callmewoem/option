...
interface HabitDao {
    ...
    /**
     * Number of active habits that do NOT yet have a completed [com.habitsfirst.androidclone.data.local.entity.HabitCompletionEntity]
     * row for [date]. Zero means every habit is done -- the signal the app-blocker
     * and home screen both key off of.
     */
    @Query(
        """
